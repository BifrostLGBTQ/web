...
const Header: React.FC = () => {
  ...
  return (
    <motion.header 
      ...
      className={`sticky top-0 z-50 backdrop-blur-2xl border-b border-card transition-colors duration-300 bg-card`}
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            <motion.div 
              className="relative w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-gray-700 via-gray-900 to-black flex items-center justify-center shadow"
              whileHover={{ 
                rotate: 2, 
                scale: 1.05,
            ...
            <div className="flex flex-col">
              <h1 className="text-lg sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent tracking-tight">
                PrideConnect
              </h1>
          ...
          <div className="flex items-center space-x-1">
            ...
            >
              ...
              <motion.span 
                className="absolute -top-1 -right-1 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gray-400 rounded-full shadow-sm"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                transition={{ delay: 0.8, type: "spring", stiffness: 500, damping: 15 }}
              />
              <div className="absolute inset-0 rounded-2xl bg-gray-700/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </motion.button>
            ...
            >
              {theme === 'dark' ? (
                ...
                <Moon className="w-4 h-4 sm:w-5 sm:h-5 text-gray-700 group-hover:text-black transition-colors duration-200" />
              )}
              <div className="absolute inset-0 rounded-2xl bg-gray-700/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </motion.button>
            ...
            <div className="relative">
              ...
              >
                <div className="relative">
                  ...
                  />
                  <div className="absolute -bottom-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-gray-400 rounded-full border-2 border-black shadow-sm" />
                </div>
              ...
              <AnimatePresence>
                {isProfileMenuOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 mt-3 w-64 bg-card rounded-2xl shadow border border-card backdrop-blur-xl"
                  >
                    <div className="p-4 border-b border-card">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400">alexr_pride@email.com</p>
                    ...
                    <div className="p-2">
                      <button className="w-full flex items-center space-x-3 px-3 py-2 text-sm text-gray-200 hover:bg-gray-800 rounded-xl transition-colors duration-200">
                      ...
                      <div className="border-t border-card my-2" />
                      <button className="w-full flex items-center space-x-3 px-3 py-2 text-sm text-gray-400 hover:bg-gray-800 rounded-xl transition-colors duration-200">
